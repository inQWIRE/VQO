...
print_and_write_file (trans_rz_add_mul_opt 4) ("trans-rz-add-mul-opt-4.qasm");;
printf "Running trans_rz_add_mul...\n%!";;
print_and_write_file (trans_rz_add_mul 4) ("trans-rz-add-mul-4.qasm");;
printf "Running trans_cl_add_mul...\n%!";;
print_and_write_file (trans_cl_add_mul 4) ("trans-cl-add-mul-4.qasm");;